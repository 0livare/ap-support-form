    ...
    <div className="flex justify-center py-10 px-4">
      <div className="w-full max-w-md p-6">
        <div className="space-y-1.5 mb-6">
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400">
            Sign in with your SkySlope Google account
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full h-10 px-4 text-sm font-medium border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
